...
export const asyncRoutes: RouteConfig[] = [
  {
    ...
    children: [{
      ...
      component: () =>
        import(
          /* webpackChunkName: "recent" */ "@/views/dashboard/index.vue"
        ),
      name: "dashboard",
      meta: {
        title: "recentitems",
    ...
    children: [
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "workflows" */ "@/views/workflows/index.vue"
          ),
        name: "workflows",
        meta: {
          title: "workflows",
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "workflows" */ "@/views/workflows/pages/edit.vue"
          ),
        name: "workflows",
        meta: {
    ...
    children: [
      {
        path: "index/:id?",
        component: () =>
          import(/* webpackChunkName: "mywork" */ "@/views/mywork/index.vue"),
        name: "mywork",
        meta: {
          title: "mywork",
          icon: "table"
    ...
    children: [
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "importExport" */ "@/views/Others/sample/tags.vue"
          ),
        name: "sample",
        meta: {
          title: "Sample",
