  ...
  >
    ...
    <el-row>
        ...
        >   
          ...
          <div class="sub-title">
              <small> (HE) A new entuty will be created with this name. Example: MyEntity </small>
          </div>
        </el-form-item>
    </el-row>
    ...
    <el-row>
        <el-form-item
          ...
          prop="displayNamePlural"
        >   
          <el-input v-model="heInput.displayNamePlural" style="width: 25%; direction: rtl" />
          <div class="sub-title">
    ...
    <el-row>
        ...
        >   
          <el-input :value="entityName + heInput.displayName" style="width: 25%; direction: rtl" />
          <div class="sub-title">
