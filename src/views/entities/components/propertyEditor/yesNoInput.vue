<template>
  <div style="padding-left: 20px">
    ...
    <PropertySelectModel
      ...
      :allowed-properties="['5']"
    />
    <prefModel
      v-if="showPreferenceModel"
      :is-open.sync="showPreferenceModel"
      :result-handler="onPrefSelected"
      :allowed-properties="['6','7']"
    />
  </div>
</template>
<script lang="ts">
import { BaseProperty, DateProperty, DateValueObject, NumericProperty, SimpleValueObject, StringProperty } from "@/models/Properties"
